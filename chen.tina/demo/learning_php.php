...
<!-- inside <>is php block =means echo block -->
<div style="color:<?= $colors[1] ?>"> 
	<!-- there is no separation statement  so no need ;-->
   This text is green
</div>
...
// Casting (cast from one type to another type)
$c = "$a";
$d = $c*1;
// (attemp $c as a number)
